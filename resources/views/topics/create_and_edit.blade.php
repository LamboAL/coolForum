                ...
                @endif
                    ...
                    <div class="form-group">
                        <select class="form-control" name="category_id" required>
                            <option value="" hidden disabled {{ $topic->id ? '' : 'selected' }}>Please select a type</option>
                    ...
                    <div class="form-group">
                        <textarea name="body" class="form-control" id="editor" rows="3" placeholder="Please fill in at least three characters." required>{{ old('body', $topic->body ) }}</textarea>
                    </div>
